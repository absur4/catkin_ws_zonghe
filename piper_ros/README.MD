...
### 2.2 运行节点
启动节点之后，先重置机械臂（要小心砸下来），·然后是能机械臂，等到机械臂到原点之后，可以开demo.launch,然后在打开moveit_control/scripts/没有server的那个py文件就好。
...
```
  ...
  source /opt/ros/noetic/setup.bash
  source /home/b/catkin_ws/devel/setup.bash
  roslaunch piper start_single_piper.launch
